    ...
    <div className=" max-[600px]:pb-4 sm:pb-2 sm:pt-40 md:pt-40">
      <div className="relative overflow-hidden  p-10 max-[600px]:pt-16 [&:lang(ar)]:font-almarai [&:lang(en)]:font-inter">
        <div className="m-auto my-10 w-5/6  max-[600px]:w-full ">
          <h1 className="mb-6 border-y  text-center text-xl font-bold leading-4 [border-img:linear-gradient(to_right,transparent,theme(colors.slate.300/.8),transparent)1] max-[600px]:text-2xl md:text-5xl [&:lang(ar)]:font-almarai  [&:lang(en)]:font-inter">
